...
Install iTunes: Download and install the latest version of iTunes (this provides the necessary USB drivers).

Setup libimobiledevice:

Download the binary from imobiledevice-net Releases.
...
⌨️ How to Use
Connect Device: Plug your phone into your computer via a high-quality USB cable.

Start the Desktop Host: Run the desktop application on your Mac or Windows machine.

Launch Mobile App: Open the Trackpad app on your Android or iOS device.
